...
REM Import printer compatibility
echo [INFO] Importing printer compatibility data...
venv\Scripts\python.exe import_printer_compatibility.py
if errorlevel 1 (
    echo [WARNING] Failed to import printer compatibility!
    echo You can import it later manually.
) else (
    echo [OK] Printer compatibility imported
)
echo.
...
echo    3. Login to web interface (admin/admin123)
echo    4. Change admin password via web interface
echo.
